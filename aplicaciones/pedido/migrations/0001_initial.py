    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dtl_tipo_pedido', models.IntegerField(choices=[(1, 'Papeleria'), (2, 'Limpieza'), (3, 'Limpieza Consultorio'), (4, 'Toner')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prod_tipo', models.IntegerField(choices=[(1, 'Papeleria'), (2, 'Limpieza'), (3, 'Limpieza Consultorio'), (4, 'Toner')], verbose_name='Tipo de producto')),
